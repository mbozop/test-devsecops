...
import { registrarCortina } from '../../api/civilo_roller_api';
...
export const AdminCurtainRegister = () => {
  ...
  const handleClick = (event) => {
    ...
    const usuarioNuevo = {
      "curtainType": nombreCortina,
    }

    registrarCortina(usuarioNuevo);
  }
  return (
    ...
    <Formulario>
      ...
      <Input type="text" name="nombreCortina" placeholder='Producto' onChange={(e) => setNombreCortina(e.target.value)} />
      <EspacioVertical />
