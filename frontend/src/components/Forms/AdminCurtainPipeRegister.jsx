...
import { registrarTubo } from '../../api/civilo_roller_api';
...
export const AdminCurtainPipeRegister = () => {
  // Define los estados para cada campo del formulario
  const [nombreTubo, setNombreTubo] = useState('');
  ...
  return (
    ...
    <Formulario>
      ...
      <Input type="text" name="nombreTubo" placeholder='Tubo de xx mm' onChange={(e) => setNombreTubo(e.target.value)} />
      <EspacioVertical />
