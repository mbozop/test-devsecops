...
import { registrarIVA } from '../../api/civilo_roller_api';
...
export const AdminIVARegister = () => {
  ...
  return (
    ...
    <Formulario>
      ...
      <Input type="number" name="porcentajeIVA" placeholder='XX%' onChange={(e) => setPorcentajeIVA(e.target.value)} />
      <EspacioVertical />
