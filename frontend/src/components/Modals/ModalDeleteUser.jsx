...
import { deleteUser } from "../../api/civilo_roller_api";
...
const ModalDeleteUser = ({ open, onClose, nombreUsuario, apellidoUsuario, userID}) => {
      ...
      <Overlay>
        <ModalContainer>
          ...
          <Container>
            ...
            <h3>{`Nombre Usuario: ${nombreUsuario} ${apellidoUsuario}`}</h3>
            <p>¿Estas seguro que deseas eliminar a este usuario? Se eliminará toda su información de manera permanente</p>
            <Opciones>
              <Boton onClick={() => {deleteUser(userID)}} style={{background:"red", borderColor:"red"}}>Eliminar</Boton>
