...
import { deleteCurtain } from "../../api/civilo_roller_api";
...
const ModalDeleteCurtain = ({ open, onClose, nombreCortina, cortinaID}) => {
      ...
      <Overlay>
        <ModalContainer>
          ...
          <Container>
            ...
            <h3>{`Producto: Cortina ${nombreCortina}`}</h3>
            <p>¿Estas seguro que deseas eliminar este producto? Se eliminará toda su información de manera permanente</p>
            <Opciones>
              <Boton onClick={() => {deleteCurtain(cortinaID)}} style={{background:"red", borderColor:"red"}}>Eliminar</Boton>
...
export default ModalDeleteCurtain;