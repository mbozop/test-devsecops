...
import { deleteCurtainPipe } from "../../api/civilo_roller_api";
...
const ModalDeleteCurtainPipe = ({ open, onClose, nombreTubo, tuboID}) => {
    ...
    open ? (
      <Overlay>
        <ModalContainer>
          ...
          <Container>
            <h1>Eliminar Tubo</h1>
            <h3>{`Tubo: ${nombreTubo}`}</h3>
            <p>¿Estas seguro que deseas eliminar este tubo? Se eliminará toda su información de manera permanente</p>
            <Opciones>
              <Boton onClick={() => {deleteCurtainPipe(tuboID)}} style={{background:"red", borderColor:"red"}}>Eliminar</Boton>
...
export default ModalDeleteCurtainPipe;