...
import { deleteIVA } from "../../api/civilo_roller_api";
...
const ModalDeleteIVA = ({ open, onClose, porcentajeIVA, ivaID}) => {
    ...
    open ? (
      <Overlay>
        <ModalContainer>
          ...
          <Container>
            <h1>Eliminar IVA</h1>
            <h3>{`IVA: ${porcentajeIVA}%`}</h3>
            <p>¿Estas seguro que deseas eliminar este IVA? Se eliminará toda su información de manera permanente</p>
            <Opciones>
              <Boton onClick={() => {deleteIVA(ivaID)}} style={{background:"red", borderColor:"red"}}>Eliminar</Boton>
